<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // Klik avatar (Desktop Sidebar) - PERBAIKI BAGIAN INI
        if (avatarBtn && profilePopup && sidebarEl) {
            avatarBtn.addEventListener('click', function (e) {
                ...
                if (!sidebarExpanded) {
                    ...
                    // TOGGLE popup: jika visible → tutup, jika hidden → buka
                    const isVisible = profilePopup.classList.contains('visible');
