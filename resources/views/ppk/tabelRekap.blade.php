    ...
    <main class="transition-all duration-300 ml-0 sm:ml-[60px]">
        <div class="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8">
            ...
            <div class="mb-3 sm:mb-4">
                <x-page-title title="Tabel Rekap Keuangan"
                    ...
                    <div class="min-w-[2200px]">
                        <table class="w-full text-xs">
                            <thead class="sticky top-0 z-10">
                                ...
                                <tr class="font-bold text-center bg-purple-200 text-gray-800">
                                    ...
                                    <th rowspan="3" class="px-3 py-2 border-2 border-gray-500 align-middle">Jumlah SP2D (Rp)
                                    </th>
                                ...
                                @forelse ($rekap as $row)
                                    ...
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-3 py-2 border text-center border-gray-400 whitespace-nowrap">
                                            {{ $row->nip }}</td>
                                        <td class="px-3 py-2 border text-center border-gray-400 whitespace-nowrap">
                                            {{ $row->pangkat_golongan ?? '-' }}</td>
                                        <td class="px-3 py-2 border text-center border-gray-400">{{ $row->dalam_rangka ?? '-' }}
                                        </td>
