...
<main class="item-center max-w-5xl min-h-screen mx-auto px-5 py-8 ">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <div>
            ...
            <p class="text-gray-500 text-sm">Pelaporan Keuangan Pegawai yang Telah Melakukan Perjalanan Dinas</p>
        </div>
    </div>
                ...
                <div class="border-t-4 border-blue-600 p-6">
                    <div class="flex flex-col sm:flex-row justify-between items-start gap-4">
                        ...
                        <div class="flex flex-col items-start sm:items-end gap-2 w-full sm:w-auto">
                            ...
                            <a href="{{ route('ppk.detailPelaporan', $perjalanan->id) }}" class="text-blue-600 hover:underline text-base font-medium mr-[30px]">
                                Lihat Detail
                            </a>
                        </div>
                    </div>
