...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function createMap(containerId, isFullscreen = false) {
        ...
        if (!Array.isArray(geoData)) return map;
        ...
        // Tambah marker (tiap titik mewakili beberapa tagging jika perlu)
        geoData.forEach(point => {
            // defensif: pastikan lat/lng valid
            if (!point || !point.lat || !point.lng) return;

            const color = colorByPerjadin[point.id_perjadin] || '#2563eb';
            ...
            // Popup ringkas: Nomor, Tujuan, Jumlah titik
            // Note: gunakan 'point' — bukan 'p' — sesuai konteks
