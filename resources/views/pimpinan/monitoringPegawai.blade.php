...
<div class="min-h-screen bg-gray-50 p-6">
    <div class="mx-auto" style="max-width: 1400px;">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <!-- Left Column - Map Placeholder and Charts -->
            <div class="space-y-6">
                <!-- Map Card -->
                <div class="bg-white rounded-lg shadow-md p-8 flex items-center justify-center border border-gray-200" style="height: 300px;">
            ...
            <div class="space-y-4">
                ...
                <div class="space-y-4 max-h-[calc(100vh-200px)] overflow-y-auto pr-2">
                    ...
                    <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-200 p-5 border-l-4 border-orange-400">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="flex items-center gap-2 pt-2 border-t border-gray-100">
                                ...
                                <p class="text-xs text-gray-600">
                                    Disetujui pada {{ \Carbon\Carbon::parse($pd->approved_at)->format('d M Y H:i') }}
                                </p>
                            </div>
                            @endif
                        </div>
